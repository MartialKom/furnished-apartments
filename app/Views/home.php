    ...
    <body>
                                ...
                                <div class="main-menu text-right <text-xl-right></text-xl-right>">
                                    <nav id="mobile-menu">
                                        <ul>
                                            ...
                                            <li><a href="<?= site_url('apartments'); ?>">Apartments </a></li>
        ...
        <main>
            ...
            <section id="home" class="slider-area fix p-relative">
				...
				<div class="single-slider slider-bg d-flex align-items-center" style="background-image:url(/public/template/img/slider/slider_img01.jpg)">
                        <div class="container">
                            <div class="row">							
                                <div class="col-lg-8">
                    ...
                    <div class="single-slider slider-bg d-flex align-items-center" style="background-image:url(/public/template/img/slider/slider_img02.jpg)">
                        <div class="container">
                            <div class="row">							
                                <div class="col-lg-8">
                                    <div class="slider-content s-slider-content text-left">
                ...
                <div class="container">
					...
					<div class="col-lg-6">
                            <div class="s-about-img p-relative">
                                <img src="/template/img/features/about_img02.png" alt="img">
			...
			<!-- counter-area -->
            <div class="counter-area pt-120 pb-90" style="background-image:url(/public/template/img/bg/count-bg.jpg); background-size:cover;">
                <div class="container">
                    <div class="row">
                ...
                <div class="container">
                    ...
                    <div class="row services-active">
                        <div class="col-xl-4">
                            <div class="single-services mb-30">
                                <div class="services-thumb">
									<a class="gallery-link popup-image" href="/template/img/gallery/gallery.jpg">
                                    <img src="/template/img/gallery/gallery.jpg" alt="img">
									</a>
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="single-services mb-30">
                                <div class="services-thumb">
									<a class="gallery-link popup-image" href="/template/img/gallery/gallery02.jpg">
                                    <img src="/template/img/gallery/gallery02.jpg" alt="img">
									</a>
                                </div>
                                <div class="services-content">                                   
                                     <small>Explore Now</small>
                        ...
                        <div class="col-xl-4">
                            <div class="single-services mb-30">
                                <div class="services-thumb">
									<a class="gallery-link popup-image" href="/template/img/gallery/gallery03.jpg">
                                    <img src="/template/img/gallery/gallery03.jpg" alt="img">
									</a>
                                </div>
                                <div class="services-content">                                   
                                    <small>Explore Now</small>
            ...
            <section class="choose-area pt-120 pb-120 p-relative" style="background:#f5f5f5;">             
                ...
                <div class="container">
                    <div class="row">
						<div class="col-xl-6">
							 <div class="s-about-img p-relative">
								<img src="/template/img/features/about_img03.png" alt="img">
								</div>
						 </div>
                        <div class="col-xl-6">
            ...
            <!-- services-area-end -->
			<!-- cta-area -->
            <section class="cta-area cta-bg pt-120 pb-120" style="background-image:url(/public/template/img/bg/cta_bg02.jpg)">
                <div class="container">
           ...
           <!-- apartments-area -->
					 ...
					 <div class="row">						
						...
						<div class="col-lg-6">
							<div class="apartments-img">
								<img src="/template/img/floor-chart.jpg" alt="floor-chart"/>
							</div>
						</div>
					</div>
				...
				<table class="table text-center">
					...
					<tbody>
							...
							<tr>
								...
								<td>
									<a class="btn popup-image" href="/template/img/floor-chart.jpg" data-elementor-open-lightbox="yes">view now </a>
								</td>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="single-post mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                                <div class="blog-thumb">
                                    <a href="blog-details.html"><img src="/template/img/blog/blog_img01.jpg" alt="img"></a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-post active mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                                <div class="blog-thumb">
                                    <a href="blog-details.html"><img src="/template/img/blog/blog_img02.jpg" alt="img"></a>
                                </div>
                                <div class="blog-content">
                                    <div class="b-meta mb-20">
                                        <ul>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-post mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                                <div class="blog-thumb">
                                    <a href="blog-details.html"><img src="/template/img/blog/blog_img03.jpg" alt="img"></a>
                                </div>
                                <div class="blog-content">
                                    <div class="b-meta mb-20">
                                        <ul>
            ...
            <!-- contact-area -->
            <section id="contact" class="contact-area contact-bg pt-120 pb-120 p-relative fix" style="background-image:url(/public/template/img/bg/contact_bg.jpg)">
                <div class="container">
                    <div class="row justify-content-center">
                    ...
                    <div class="row brand-active">
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="/template/img/brand/c-logo1.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="/template/img/brand/c-logo2.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="/template/img/brand/c-logo3.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="/template/img/brand/c-logo4.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="/template/img/brand/c-logo5.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="/template/img/brand/c-logo6.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-2">
                            <div class="single-brand">
                        ...
                        <div class="col-xl-6 col-lg-6 col-sm-6">
                            <div class="footer-widget mb-30">
                                <div class="logo mb-35">
                                    <a href="#"><img src="/template/img/logo/logo.png" alt="logo"></a>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="copyright-text text-center">
                                <p>&copy; <?= date('Y') ?> Relxtower. Tamaroas-Dev.</p>
                            </div>
                        </div>
                    </div>
                </div>
